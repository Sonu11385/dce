...
<Link to="/Guest House" className="list-group-item list-group-item active">Guest House</Link>
...
<Link to="/Wifi" className="list-group-item list-group-item-action">Wi-fi</Link>
