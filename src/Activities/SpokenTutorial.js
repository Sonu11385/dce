...
export default function SpokenTutorial() {
  return (
  ...
  <Link to="/Spoken Tutorial" className="list-group-item list-group-item-action active">Spoken Tutorial</Link>
</div>
<div style={{marginLeft:"100px",marginTop:"20px",width:"800px"}}>
  <h3>Spoken Tutorial</h3>
  <hr></hr>
</div>
    </div>
  )
