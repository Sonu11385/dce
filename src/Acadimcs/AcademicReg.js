...
export default function AcademicReg() {
  return (
    <div style={{ display: "flex" }}>
      ...
      >
        <h3>Academic Regulation</h3>
        <hr></hr>
        <embed
          src="https://www.dce-darbhanga.org/wp-content/uploads/2019/02/ARYABHATT_-REGULATION.pdf"
          width="800"
          height="700"
        />
        <br></br>
        <a
          href="https://www.dce-darbhanga.org/wp-content/uploads/2019/02/ARYABHATT_-REGULATION.pdf"
          target="_blank"
          rel="noreferrer"
        >
          Download
