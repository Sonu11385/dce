...
export default function EorP() {
  ...
  <Link to="/Engagement or Partnership" className="list-group-item list-group-item-action active">Engagement or Partnership</Link>
...
<h3>Engagement or Partnership</h3>
<hr></hr>               
</div>
    </div>
  )
